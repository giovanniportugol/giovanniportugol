...
Sou estudante de **Análise e Desenvolvimento de Sistemas pela Estácio** e estou em transição para a área de **Tecnologia da Informação**.

Atualmente estou estudando e desenvolvendo conhecimentos em **Python, SQL, lógica de programação, Dart, Flutter, desenvolvimento mobile, sistemas web, suporte técnico e fundamentos de TI**.

Tenho conhecimentos acadêmicos e em desenvolvimento em:
...
Busco oportunidade inicial, estágio ou posição júnior na área de Tecnologia da Informação, especialmente em:
...
Tenho disposição para aprender novas tecnologias, desenvolver habilidades práticas e contribuir com responsabilidade, organização, raciocínio lógico e postura ética.
